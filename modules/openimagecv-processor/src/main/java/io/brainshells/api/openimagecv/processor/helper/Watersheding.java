...
public class Watersheding {
    ...
    public static void main(final String[] args) throws IOException {
        BufferedImage inputImage = readImage(args[0]);
