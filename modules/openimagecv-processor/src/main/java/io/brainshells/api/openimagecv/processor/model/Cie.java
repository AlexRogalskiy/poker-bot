...
public class Cie {
    ...
    public static Cie rgb2cie3(double R, double G, double B) {
        final double X = 0.436052025f * R + 0.385081593f * G + 0.143087414f * B;
        final double Y = 0.222491598f * R + 0.71688606f * G + 0.060621486f * B;
        final double Z = 0.013929122f * R + 0.097097002f * G + 0.71418547f * B;
