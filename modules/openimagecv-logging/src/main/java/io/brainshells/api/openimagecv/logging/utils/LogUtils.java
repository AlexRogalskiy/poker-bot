...
public class LogUtils {
    ...
    private static final DateTimeFormatter d1 = DateTimeFormatter
        .ofPattern("yyyyMMdd");
    private static final DateTimeFormatter d2 = DateTimeFormatter
        .ofPattern("yyyy-MM-dd");
    private static final DateTimeFormatter d3 = DateTimeFormatter
        .ofPattern("HHmmss");

    private static final Map<String, String> THREAD_NAME_CACHE = new HashMap<>();
    private static final Map<String, String> CLASS_NAME_CACHE = new HashMap<>();

    private static final boolean isWindows;

    static {
        isWindows = System.getProperties().getProperty("os.name").toLowerCase()
            .contains("win");
    }
    ...
    public static String getColorShortName(String className) {
        ...
        int len = 31;
        final StringBuilder shortName = buildShortName(className);
    ...
    public static String getColorThreadPadding() {
        ...
        String val =
            "[ " + padLeft(Thread.currentThread().getName(), 17) + " ] ";
