...
public final class ImageTransformationUtils {
     ...
     * @param maxWidth  the desired width of the scaled instance, in pixels
     * @param maxHeight the desired height of the scaled instance, in pixels
     * @return a scaled version of the original {@code BufferedImage}
     */
    public static BufferedImage scaleImage(final BufferedImage img,
        final int maxWidth,
        final int maxHeight) {
     ...
     *
     * @param img           the original image to be scaled
     * @param maxWidth      the desired width of the scaled instance, in
     *                      pixels
     * @param maxHeight     the desired height of the scaled instance, in
     *                      pixels
     ...
     *                      technique that provides higher quality than the
     *                      usual one-step technique (only useful in
     *                      downscaling cases, where {@code targetWidth} or
     *                      {@code targetHeight} is smaller than the original
     *                      dimensions, and generally only when the {@code
    ...
    public static BufferedImage scaleImage(final BufferedImage img,
        ...
        boolean downScale =
            img.getWidth() > maxWidth || img.getHeight() > maxHeight;
        ...
        do {
            ...
            final BufferedImage tmp = new BufferedImage(currentWidth,
                currentheight,
                type);
