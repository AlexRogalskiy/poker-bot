...
public final class BufferedImageLuminanceSource extends LuminanceSource {
    ...
    private static final double MINUS_45_IN_RADIANS = Math.toRadians(-45.0);
            ...
            for (int y = top; y < top + height; y++) {
                ...
                for (int x = 0; x < width; x++) {
                    ...
                    if ((pixel & 0xFF000000) == 0) {
                        ...
                        // (306*R) >> 10 is approximately equal to R*0.299,
                        // and so on.
                        // 0x200 >> 10 is 0.5, it implements rounding.
                        buffer[x] = (306 * ((pixel >> 16) & 0xFF) +
                            601 * ((pixel >> 8) & 0xFF) +
                            117 * (pixel & 0xFF) + 0x200) >> 10;
                    }
                }
    ...
    public LuminanceSource rotateCounterClockwise() {
        ...
        BufferedImage rotatedImage =
            new BufferedImage(sourceHeight, sourceWidth,
                BufferedImage.TYPE_BYTE_GRAY);
    ...
    public LuminanceSource rotateCounterClockwise45() {
        ...
        AffineTransform transform =
            AffineTransform.getRotateInstance(MINUS_45_IN_RADIANS, oldCenterX,
                oldCenterY);

        int sourceDimension = Math.max(image.getWidth(), image.getHeight());
        BufferedImage rotatedImage =
            new BufferedImage(sourceDimension, sourceDimension,
                BufferedImage.TYPE_BYTE_GRAY);
        ...
        return new BufferedImageLuminanceSource(rotatedImage, newLeft, newTop,
