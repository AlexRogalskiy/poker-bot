...
public class Gradient {
    ...
    /**
     * Take this gradient and average it with another ensuring that the
     * resulting equation would hit the given point The provided DataPoint is
     * there to help adjust for rounding errors when this is used to
     * extrapolate on graphs
     *
