...
/**
 * This object extends LuminanceSource around an array of YUV data returned
 * from the camera driver,
 * with the option to crop to a rectangle within the full data. This can be
 * used to exclude
...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
    ...
    public byte[] getMatrix() {
        ...
        for (int y = 0; y < height; y++) {
            ...
            System.arraycopy(yuvData, inputOffset, matrix, outputOffset,
                width);
    ...
    public int[] renderThumbnail() {
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                int grey =
                    yuv[inputOffset + x * THUMBNAIL_SCALE_FACTOR] & 0xff;
