...
public abstract class AbstractTextRenderer implements TextRenderer {
    ...
    protected abstract void arrangeCharacters(int width, int height,
        TextString ts);
    ...
    public void draw(String text, BufferedImage canvas,
        FontFactory fontFactory, ColorFactory colorFactory) {
        Graphics2D g = (Graphics2D) canvas.getGraphics();
        TextString ts = convertToCharacters(text, g, fontFactory,
            colorFactory);
    ...
    protected TextString convertToCharacters(String text, Graphics2D g,
        FontFactory fontFactory, ColorFactory colorFactory) {
